 ...
 */
public class NRRClass /*implements PanelInterface*/ {
    public static final Logger logger_job = Logger.getLogger(NRRClass.class);
...
jScrollPane1.setViewportView(jTable1);
    ...
    private void getContextFile(String fn) {
        ...
        try {
            ...
            int count = 0;
            String a = LoadData.getPropTitles("NRR");
    ...
    public int getNRRAll(String fName)
    {
    ...
    public int getNRR(String fName, int i)
    {
    ...
    public int getMaxNRR(String fName)
    {
    ...
    public int getCountNRR(String fName)
    {
    ...
    public void saveDataFromAZR(String fName, String data)
    {
        fileName = LoadData.getPathJantar12() + "Data/" + fName;
        try {
            try (PrintWriter pw = new PrintWriter(new OutputStreamWriter(new FileOutputStream(fileName), "Cp1251"))) {
