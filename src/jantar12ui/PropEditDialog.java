 ...
 */
public class PropEditDialog extends javax.swing.JDialog {
    private boolean editText;

    /**
     * Creates new form DescriptDialog
     */
    public PropEditDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
    }
    public void setDescript(String title, String text, boolean err)
    {
        ...
        if(err)
        {
            jButtonSaveComm.setVisible(false);
    ...
    private void initComponents() {
        ...
        jButtonCancelComm.setText("Отменить");
        jButtonCancelComm.setActionCommand("Закрыть");
    ...
    private void jButtonSaveCommActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveCommActionPerformed
        ...
        LoadData.setFile(this.getTitle(), jTextArea1.getText());
        setVisible(false);
    ...
    private void jButtonCancelCommActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCancelCommActionPerformed
        ...
        if(editText)
        {
            if(JOptionPane.showConfirmDialog(this, "Сохранить настройки?", "Сохранить настройки?", JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION)
            {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PropEditDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                PropEditDialog dialog = new PropEditDialog(new javax.swing.JFrame(), true);
